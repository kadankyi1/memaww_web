...
<html lang="en">
<head>
  <title>Delete My Info - MeMaww</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  
  <meta name="description" content="Delete My Info - MeMaww">
  <meta name="keywords" content="Delete My Info MeMaww, MeMaww Laundry, Ghana Laundry, Laundry Ghana">
  ...
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
       <p class="breadcrumbs"><span class="mr-2"><a href="/">Home <i class="fa fa-chevron-right"></i></a></span> <span>Delete My Info <i class="fa fa-chevron-right"></i></span></p>
       <h1 class="mb-0 bread">Delete My Info</h1>
     </div>
   </div>
 </div>
</section>
...
<section class="ftco-section ftco-no-pb contact-section mb-4">
   <div class="container">
      <ol>
         <li>Send an email to <a><strong>support@memaww.com</strong></a> with subject "DELETE MY INFO - [PHONE NUMBER USED FOR SIGN UP]</li>
         <li>In the email, simply list what you would like us to delete, and if you would like us to delete all your info, just say "Delete all my info"</li>
      </ol>
   </div>
</section>
