...
<html lang="en">
<head>
	<title>MeMaww - A Laundry Service</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	
	<meta name="description" content="Place Order - MeMaww">
	<meta name="keywords" content="Place Order MeMaww, Order MeMaww, MeMaww Laundry, Ghana Laundry, Laundry Ghana">
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html" style="font-family: MeMaww; font-size: 30px">MeMaww<span style="font-family: sans-serif">A Laundry Service</span></a>
		...
		<div class="container">
			<div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
				<div class="col-md-7 ftco-animate">
					...
					<h1 class="mb-4">Why Waste Time Washing?</h1>
					<p class="caps">We are bringing convenience and affordability to laundry services</p>
				</div>
			</div>
		</div>
	</div>
												...
												<div class="col-md d-flex">
													<div class="form-group p-4">
														...
														<div class="form-field">
															...
															<input type="text" class="form-control checkout_date" placeholder="Phone Number">
														</div>
													</div>
												</div>
												<div class="col-md d-flex">
				...
				<div class="row d-flex">
					<div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate d-flex align-items-center">
						<div class="w-100" id="apps">
							...
							<p>
								At our facilities, your clothes will be handled in line with your order. 
								Once everything is ready, we'll deliver it back to your door on your requested day.
							</p>
							<div style="display: inline-block; width: 100%;">
								<a href="#"><img src="images/app-store.png" style="height: 60px;"/></a>
								<a href="#"><img src="images/play-store.png" style="height: 60px;"/></a>
							</div>
						</div>
					</div>
					<div class="col-md-6">
							...
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-1 d-block img" style="background-image: url(images/services-1.jpg);">
									...
									<div class="media-body">
										<h3 class="heading mb-3">Good Rates</h3>
										<p>We strive to provide the lowest rates possible so you don't break the bank</p>
									</div>
								</div>      
							</div>
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-2 d-block img" style="background-image: url(images/services-2.jpg);">
									...
									<div class="media-body">
										<h3 class="heading mb-3">Free Pickup & Delivery</h3>
										<p>MeMaww partners with industry friends to pick up and deliver your clothes at no cost to you. </p>
									</div>
								</div>    
							</div>
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-3 d-block img" style="background-image: url(images/services-3.jpg);">
									...
									<div class="media-body">
										<h3 class="heading mb-3">Clean Or Refund</h3>
										<p>We love providing this service to you. So if we don't clean your clothes well, show us proof and get a refund.</p>
									</div>
								</div>      
							</div>
							<div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
								<div class="services services-1 color-4 d-block img" style="background-image: url(images/services-4.jpg);">
									...
									<div class="media-body">
										<h3 class="heading mb-3">Tracking</h3>
										<p>With MeMaww you can use our mobile Apps to easily check on the status of your order</p>
									</div>
								</div>      
							</div>
						</div>
