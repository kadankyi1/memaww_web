...
class UtilController extends Controller
{
    ...
    public static function checkUserAppVersionCode($app_type, $app_version_code)
    {
        ...
        if (strtoupper($app_type) == "ANDROID" && 
            ...
            return ["status" => "update", "message" => "Please update your app from the Google Play Store", "subscription_set" => false, "app_link" => config('app.google_playstore_appid')];
            ...
            return ["status" => "update", "message" => "Please update your app from the App Store", "subscription_set" => false, "app_link" => config('app.google_playstore_appid')];
