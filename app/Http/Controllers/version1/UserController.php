    ...
    */
    ...
    public function requestCollection(Request $request){
        ...
        return response([
            ...
            "price_final_ios" => sprintf("%012d", (intval($final_price) * 100)),
    ...
    public function updateOrderPaymentStatus(Request $request){
        ...
        if($payment_verify->status == "approved" || $request->order_payment_status == "pay_on_pickup"){
            ...
            $email_data = array(
                ...
                'order_mediumweightitems_just_wash_quantity' => $the_order->order_mediumitems_justwash_quantity,
                'order_mediumweightitems_wash_and_iron_quantity' => $the_order->order_mediumitems_washandiron_quantity,
                'order_mediumweightitems_just_iron_quantity' => $the_order->order_mediumitems_justiron_quantity,
...
*/
    ...
    function getSubscriptionPricing(Request $request){
        ...
        */
        ...
        $subscription_id = str_pad(auth()->user()->user_id . date('ymis'),12,"00",STR_PAD_RIGHT);
        $subs_index = "sub_" . $request->subscription_max_number_of_people_in_home . "_ppl_" . $request->subscription_number_of_months . "month";

        $offers_array = [
            "sub_1_ppl_1month" => strval(ceil(217*1)), //strval(1),// 0% off
            ...
            "sub_5_ppl_1month" => strval(ceil(754*1)), // 12% off
            "sub_6_ppl_1month" => strval(ceil(945*1)), // 12% off  (217 * number of people) - 200
            "sub_7_ppl_1month" => strval(ceil(1136*1)), // 12% off (217 * number of people) - 200
            "sub_8_ppl_1month" => strval(ceil(1310*1)), // 13% off  (217 * number of people) - 200
            "sub_9_ppl_1month" => strval(ceil(1479*1)), // 14% off (217 * number of people) - 200
            "sub_10_ppl_1month" => strval(ceil(1844*1)), // 15% off (217 * number of people) - 200


            "sub_1_ppl_3month" => strval(ceil(217*3*0.85)), // 0% off
            "sub_2_ppl_3month" => strval(ceil(305*3*0.85)), // 15% off
            "sub_3_ppl_3month" => strval(ceil(372*3*0.85)), // 12% off
            "sub_4_ppl_3month" => strval(ceil(563*3*0.85)), // 12% off
            "sub_5_ppl_3month" => strval(ceil(754*3*0.85)), // 12% off
            "sub_6_ppl_3month" => strval(ceil(945*3*0.85)), // 12% off  (217 * number of people) - 200
            "sub_7_ppl_3month" => strval(ceil(1136*3*0.85)), // 12% off (217 * number of people) - 200
            "sub_8_ppl_3month" => strval(ceil(1310*3*0.85)), // 13% off  (217 * number of people) - 200
            "sub_9_ppl_3month" => strval(ceil(1479*3*0.85)), // 14% off (217 * number of people) - 200
            "sub_10_ppl_3month" => strval(ceil(1844*3*0.85)), // 15% off (217 * number of people) - 200


            "sub_1_ppl_6month" => strval(ceil(217*6*0.75)), // 0% off
            "sub_2_ppl_6month" => strval(ceil(305*6*0.75)), // 15% off
            "sub_3_ppl_6month" => strval(ceil(372*6*0.75)), // 12% off
            "sub_4_ppl_6month" => strval(ceil(563*6*0.75)), // 12% off
            "sub_5_ppl_6month" => strval(ceil(754*6*0.75)), // 12% off
            "sub_6_ppl_6month" => strval(ceil(945*6*0.75)), // 12% off  (217 * number of people) - 200
            "sub_7_ppl_6month" => strval(ceil(1136*6*0.75)), // 12% off (217 * number of people) - 200
            "sub_8_ppl_6month" => strval(ceil(1310*6*0.75)), // 13% off  (217 * number of people) - 200
            "sub_9_ppl_6month" => strval(ceil(1479*6*0.75)), // 14% off (217 * number of people) - 200
            "sub_10_ppl_6month" => strval(ceil(1844*6*0.75)), // 15% off (217 * number of people) - 200

            "sub_1_ppl_12month" => strval(ceil(217*12*0.7)), // 0% off
            "sub_2_ppl_12month" => strval(ceil(305*12*0.7)), // 15% off
            "sub_3_ppl_12month" => strval(ceil(372*12*0.7)), // 12% off
            "sub_4_ppl_12month" => strval(ceil(563*12*0.7)), // 12% off
            "sub_5_ppl_12month" => strval(ceil(754*12*0.7)), // 12% off
            "sub_6_ppl_12month" => strval(ceil(945*12*0.7)), // 12% off  (217 * number of people) - 200
            "sub_7_ppl_12month" => strval(ceil(1136*12*0.7)), // 12% off (217 * number of people) - 200
            "sub_8_ppl_12month" => strval(ceil(1310*12*0.7)), // 13% off  (217 * number of people) - 200
            "sub_9_ppl_12month" => strval(ceil(1479*12*0.7)), // 14% off (217 * number of people) - 200
            "sub_10_ppl_12month" => strval(ceil(1844*12*0.7)), // 15% off (217 * number of people) - 200
        ];
        ...
        return response([
            ...
            "subscription_price_ios" => sprintf("%012d", (intval($offers_array[$subs_index]) * 100)),
    ...
    public function setUserSubscription(Request $request){
        ...
        if(
            ($request->subscription_max_number_of_people_in_home == "1" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) <  floatval(ceil(217*1))) //floatval(1))
            ...
            || ($request->subscription_max_number_of_people_in_home == "5" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(754*1)))
            || ($request->subscription_max_number_of_people_in_home == "6" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(945*1)))
            || ($request->subscription_max_number_of_people_in_home == "7" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(1136*1)))
            || ($request->subscription_max_number_of_people_in_home == "8" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(1310*1)))
            || ($request->subscription_max_number_of_people_in_home == "9" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(1479*1)))
            || ($request->subscription_max_number_of_people_in_home == "10" && $request->subscription_number_of_months == "1" && floatval($payment_verify->amount) < floatval(ceil(1844*1)))

            || ($request->subscription_max_number_of_people_in_home == "1" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(217*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "2" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(305*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "3" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(372*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "4" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(563*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "5" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(754*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "6" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(945*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "7" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(1136*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "8" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(1310*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "9" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(1479*3*0.85)))
            || ($request->subscription_max_number_of_people_in_home == "10" && $request->subscription_number_of_months == "3" && floatval($payment_verify->amount) < floatval(ceil(1844*3*0.85)))

            || ($request->subscription_max_number_of_people_in_home == "1" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(217*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "2" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(305*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "3" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(372*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "4" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(563*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "5" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(754*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "6" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(945*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "7" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(1136*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "8" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(1310*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "9" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(1479*6*0.75)))
            || ($request->subscription_max_number_of_people_in_home == "10" && $request->subscription_number_of_months == "6" && floatval($payment_verify->amount) < floatval(ceil(1844*6*0.75)))

            || ($request->subscription_max_number_of_people_in_home == "1" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(217*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "2" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(305*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "3" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(372*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "4" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(563*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "5" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(754*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "6" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(945*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "7" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(1136*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "8" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(1310*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "9" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(1479*12*0.7)))
            || ($request->subscription_max_number_of_people_in_home == "10" && $request->subscription_number_of_months == "12" && floatval($payment_verify->amount) < floatval(ceil(1844*12*0.7)))
            ){
                return response([
                    "status" => "error", 
